...
export default function data() {
  ...
  return {
    ...
    rows: [
      {
        employee: <Employee image={team2} name="John Michael" email="john@creative-tim.com" />,
        position: <Position title="Manager" description="Organization" />,
        status: (
          <MDBox ml={-1}>
      ...
      },
      {
        ...
        position: <Position title="Programator" description="Developer" />,
        status: (
          <MDBox ml={-1}>
      ...
      {
        employee: (
          <Employee image={team4} name="Laurent Perrier" email="laurent@creative-tim.com" />
        ),
        position: <Position title="Executive" description="Projects" />,
        status: (
          <MDBox ml={-1}>
      ...
      },
      {
        ...
        position: <Position title="Manager" description="Executive" />,
        status: (
          <MDBox ml={-1}>
            <MDBadge badgeContent="offline" color="dark" variant="gradient" size="sm" />
          </MDBox>
